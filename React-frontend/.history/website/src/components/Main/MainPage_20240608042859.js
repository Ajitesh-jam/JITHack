...
const MainPage = () => {
  ...
  useEffect(() => {
    // You can use the username here or perform any other actions
    console.log("Username:", username);
  }, [username]); // Add username to the dependency array to trigger the effect when it changes

  return (
    <div className="main-page">
      <CarouselSection username={username} title="Skins" />
      <CarouselSection username={username} title="Animations" />
      <CarouselSection username={username} title="Artist" />
      <CarouselSection username={username} title="Colors" />
    </div>
  );
};
